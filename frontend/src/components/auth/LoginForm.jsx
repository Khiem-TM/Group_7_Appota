...
function LoginForm() {
  ...
  const handleSubmit = (event) => {
    ...
    alert(`Mock login submitted for ${form.email}`);
  };
  ...
  return (
    <form onSubmit={handleSubmit} className="soft-panel space-y-4 p-6">
      ...
      <button type="submit" className="w-full rounded-xl bg-cyan-500 px-4 py-2 font-semibold text-slate-950 hover:bg-cyan-400">
        Sign In
      </button>
    </form>
  );
